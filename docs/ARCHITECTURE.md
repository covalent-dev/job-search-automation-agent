...
search:
  ...
  detail_description_fetch: false  # OFF until recon complete
...
**Why**: Each board has different HTML structures. Enabling without recon leads to broken selectors or missing data.
...
- Multi-board orchestration script
- Description capture for more boards (pending recon)
